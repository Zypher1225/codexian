...
describe('InstructionModeManager', () => {
  it('should enter instruction mode on # keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('codexian-input-instruction-mode');
  });
  ...
  it('should exit instruction mode when input is cleared', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('codexian-input-instruction-mode');
  });
