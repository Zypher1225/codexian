...
describe('Async Subagent Renderer', () => {
  ...
  it('shows prompt in content and keeps label visible while running', () => {
    ...
    const contentText = getTextByClass(state.contentEl as any, 'codexian-subagent-prompt-text')[0];
  ...
  it('finalizes to completed and reveals description', () => {
    ...
    const contentText = getTextByClass(state.contentEl as any, 'codexian-subagent-result-output')[0];
  ...
  describe('renderStoredAsyncSubagent', () => {
    it('should return wrapper element', () => {
      ...
      expect((wrapperEl as any).hasClass('codexian-subagent-list')).toBe(true);
    });
    ...
    it('renders error status correctly', () => {
      ...
      const contentText = getTextByClass(wrapperEl as any, 'codexian-subagent-result-output')[0];
    ...
    it('renders running status with prompt', () => {
      ...
      const contentText = getTextByClass(wrapperEl as any, 'codexian-subagent-prompt-text')[0];
...
describe('renderStoredSubagent status variants', () => {
  ...
  it('shows correct tool count in badge', () => {
    ...
    const countTexts = getTextByClass(wrapperEl as any, 'codexian-subagent-count');
